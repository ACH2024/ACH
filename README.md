...
```shell
python3 src/main.py --alg-config=qmix --env-config=sc2 with env_args.map_name=2s3z
```
...
```shell
bash run.sh $GPU python3 src/main.py --alg-config=qmix --env-config=sc2 with env_args.map_name=2s3z
```
